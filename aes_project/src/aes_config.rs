// Define public constants for AES key length
pub const AES_VERSION: u32 = 128; // Can be 128, 192, or 256

// Define public constant for AES block size
pub const AES_BLOCK_SIZE: usize = 16;

// Define public constants Nk and Nr based on AES key length
